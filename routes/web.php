...
Route::patch('/pengiriman/{id}/update-status', [PengirimanController::class, 'updateStatus'])->name('update.status');
...
Route::delete('/sponsor-request/{request}', [SponsorRequestController::class, 'destroy'])->name('sponsor-request.destroy');
...
// Route::resource('bahanmentah', BahanMentahController::class);
Route::get('/bahanmentah', [BarangController::class, 'index'])->name('bahanmentah.index');
Route::get('/bahanmentah/edit/{id}', [BarangController::class, 'edit'])->name('bahanmentah.edit');
Route::get('/bahanmentah/create', [BarangController::class, 'create'])->name('bahanmentah.create');
Route::get('/bahanmentah-print', [BahanMentahController::class, 'printlapbahanmentah']);
Route::post('/bahanmentah/store', [BahanMentahController::class, 'store'])->name('bahanmentah.store');
Route::put('/bahanmentah/update/{id}', [BahanMentahController::class, 'update'])->name('bahanmentah.update');
Route::delete('/bahanmentah/destroy/{id}', [BahanMentahController::class, 'destroy'])->name('bahanmentah.destroy');
...
Route::group(['middleware' => ['auth', 'ceklevel:superadmin']], function () {
    ...
    Route::get('/laporan-penjualan/outlet/{customerId}', [LaporanController::class, 'outlet']);

    Route::get('/outlet/{customerId}', [LaporanController::class, 'outlet'])->name('outlet');
    Route::get('/generate-pdf/{customerId}/{startDate?}/{endDate?}', [LaporanController::class, 'generatePdf'])->name('generatePdf');

    // Route::get('/laporan-penjualan/outlet/{customerId}', [LaporanController::class, 'showOutlet']);

    // Route::get('/laporan/{customerId}/outlet', [LaporanController::class, 'showOutlet'])->name('outlet.show');
    // Route::get('/laporan/{customerId}/pdf', [LaporanController::class, 'printPDF'])->name('pdf.download');

    // Route::get('/laporan-penjualan/outlet/{customertId}', [LaporanController::class, 'outlet']);
    // Route::get('/laporan-penjualan/detail/{id}', [LaporanController::class, 'produk']);
    // Route::get('/laporan-penjualan/lihat/detail/{id}', [ProductController::class, 'lihatDetailOrder'])->name('lihat.detail');
    // Route::get('/laporan-penjualan/produk/{productId}', [LaporanController::class, 'showProductDetails']);
    Route::get('/laporan-penjualan/produk/{productId}', [LaporanController::class, 'showProduct']);
Route::post('/laporan-penjualan/produk/{productId}/generate-pdf', [LaporanController::class, 'generateProductReport']);
...
Route::get('/menumyinvoice', [HomeController::class, 'menumyinvoice']);
