...
class HomeController extends Controller
{
    ...
    public function menumyinvoice()
    {
        $invoice  = Invoice::with(['user', 'customer', 'detail'])->where('user_id', Auth::user()->id)->orderBy('created_at', 'DESC')->get();
        $invoiceppn  = Invoiceppn::with(['user', 'customer', 'detailppn'])->where('user_id', Auth::user()->id)->orderBy('created_at', 'DESC')->get();
        return view('beranda.menumyinvoice', compact('invoice','invoiceppn'));
    }
