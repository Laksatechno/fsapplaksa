...
class InvoiceppnController extends Controller
{
        ...
        try {
            ...
            if ($invoice_detailppn) {
                ...
                Invoice_detailppn::create([
                    ...
                    'price' => $detail->price,
                    'qty' => $request->qty,
                    'diskon' => $diskonAmount, // Store the discount amount instead of percentage
    ...
    public function destroy($id)
    {
        ...
        foreach ($details as $detailppn) {
            $inventory = $detailppn->productDetail->product;
            $inventory->stock += $detailppn->qty;
            $inventory->save();
            $detailppn->delete();
        }
