                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ url('/daily-report-marketing/new') }}" class="btn btn-primary btn-sm float-right"><ion-icon name="add-circle-outline"></ion-icon> Report</a>
                            </div>                      
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover table-bordered" id="dailyreport-table" class="table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach($dailyreportmkts as $dailyreportmkt)
                                        <tr>
