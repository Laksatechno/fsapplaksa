...
<a href="{{('/sponsor-request/index') }}"><i class="mdi mdi-pencil btn btn-success">Riwayat</i></a>
<form action="{{ url('/sponsor-request') }}" method="post">
    ...
    <div class="form-group">
        ...
        <input type="date" name="waktu_kegiatan" class="form-control" placeholder="Isi Waktu" required>
    </div>
