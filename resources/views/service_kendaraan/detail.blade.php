            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <b class="card-title">Tambah Pengajuan Service Detail</b>
                    </div>
                    <div class="table-responsive">
                        ...
                        <div class="table-responsive">
                            ...
                            @endif
                            <table class="table table-hover table-bordered" id="detail-kendaraan-table" class="table" cellspacing="0" width="100%">
